                                    ...
                                    <article class="col-md-6 animate-box section_margin">
                                        <div class="wrap">
                                            <figure class="alith_news_img">
                                                ...
                                                <a href="{{Route('kz.Article',$article->id)}}"><img src="{!! $article->path !!}" alt=""/></a>
                                            </figure>
                                        </div>
                                        <h3 class="alith_post_title"><a href="{{Route('kz.Article',$article->id)}}">{{$article->titlekz}}</a></h3>
                                        <div class="post_meta">

                                            <span class="meta_author_name"><a href="{{Route('kz.Article',$article->id)}}" class="author">{{$article->author}}</a></span>
