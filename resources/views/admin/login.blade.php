...
<div class="login-box">
    <div class="logo">
        <a href="javascript:void(0);" style="color: #000;"><b>THE KHAN TIME</b></a>
    </div>
    <div class="card">
        <div class="body">
            <form id="sign_in" method="POST" action="{{route('admin.Login')}}">
                ...
                <div class="row m-t-15 m-b--20">
                    ...
                    <div class="col-xs-6">
                        <button class="btn btn-block  waves-effect" type="submit" style="color:#000;background-color: #ffff;">ВОЙТИ</button>
                    </div>
                </div>
            </form>
        </div>
