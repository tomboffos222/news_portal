                        ...
                        <div class="col-12 col-md-12 main_nav_cover" id="nav">
                            <ul id="main-menu">
                                <li class="menu-item-has-children"><a href="{{Route('kz.Home')}}">Санат</a>
                                    <ul class="sub-menu">
                                        @foreach($cats as $cat)
                                            <li><a href="{{Route('kz.ArticleCategory',$cat->id)}}">{{$cat->name}}</a></li>
                                        @endforeach
                                ...
                                <div class="alith_latest_trading_img_position_relative">
                                    ...
                                    <div class="alith_post_title_small">
                                        <a href="{{Route('kz.Article',$newArticle->id)}}"><strong>@php
                                                    echo mb_strimwidth($newArticle['titlekz'],0,20,'...');
                                                @endphp</strong></a>
                                        <p class="meta"><span>{{$newArticle->created_at}}</span> <span>{{$newArticle->views}} көріністер</span></p>
                                    </div>
                                </div>
                            </div>
                        @endforeach
